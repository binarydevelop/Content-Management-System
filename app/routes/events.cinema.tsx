...
import { getStartAndEndOfMonth } from "~/utils/helper"; // Import the new helper function
...
export const loader = async ({ request }: { request: Request }) => {
  ...
  // Pass startDate and endDate to the API call
  return fetchEvents({ page, perPage, eventType: 'movie', startDate, endDate });
};
...
export default function Cinema() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4 text-center">Cinema Hall</h1>
